...
public class Lista_TrechosVoltaArrayAdapter extends BaseAdapter implements ListAdapter {
    ...
    private Lista_TrechosVoltaArrayAdapter.ViewHolder holder;
    ...
    public Lista_TrechosVoltaArrayAdapter(List<fields_trecho> list, Context context, float tamanho_piscina) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = new Lista_TrechosVoltaArrayAdapter.ViewHolder(view);
            view.setTag(holder);
            ...
            view = convertView;
            holder = (Lista_TrechosVoltaArrayAdapter.ViewHolder) view.getTag();
        ...
        holder.np_tamanho.setMaxValue(3);
